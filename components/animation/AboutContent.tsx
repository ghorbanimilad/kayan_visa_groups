...
const AboutContent = () => {
      ...
      const shouldReduceMotion = useReducedMotion() // بهینه‌سازی انیمیشن‌ها برای سیستم کند
      ...
      const textRotate = useTransform(scrollY, [0, 300], [0, 1.5])
      ...
      return (
            <div className='min-h-screen container mx-auto'>
                  ...
                  >
                        ...
                        >
                              <Image
                                    ...
                                    alt="درباره ما موسسه مهاجرتی کایان"
                                    fill
                        ...
                        <motion.div
                              style={shouldReduceMotion ? {} : { y: textY, scale: textScale, rotate: textRotate }}
                              initial={{ opacity: 0 }}
                              animate={{ opacity: 1 }}
                        ...
                        >
                              ...
                              <p className="text-white text-sm md:text-lg max-w-2xl">
                                    ارائه خدمات مشاوره و حمایت کامل از متقاضیان مهاجرت به کشورهای مختلف با بیش از 19 سال تجربه
                              </p>
                        </motion.div>
                  </motion.div>
                  ...
                  >
                        <h1 className='font-bold text-center md:text-right text-gray-800 text-xl'>
                              درباره موسسه مهاجرتی  <span className='text-red-500'>(کایان)</span>
                        </h1>
                        <p className='text-gray-700 text-sm md:text-md mt-4 leading-loose'>
                              موسسه مهاجرتی کایان با هدف ارائه خدمات مشاوره و حمایت از متقاضیان مهاجرت به کشورهای مختلف تأسیس شده است. تیم ما متشکل از وکلای مجرب و مشاوران حرفه‌ای در زمینه مهاجرت است که با دانش و تجربه خود، بهترین راهکارها را برای مشتریان خود ارائه می‌دهند. موسسه ما به عنوان یک پل ارتباطی بین متقاضیان و کشورهای مقصد عمل می‌کند و سعی در تسهیل فرآیند مهاجرت دارد. موسسه کایان با بیش از 19 سال تجربه در این زمینه، آماده است تا به شما در تحقق اهداف مهاجرتی‌تان کمک کند.
                        </p>
                  </motion.div>
                  ...
                  >
                        ...
                        <p className='text-gray-700 text-sm md:text-md mt-4 leading-loose'>
                              موسسه مهاجرتی کایان با بیش از 19 سال تجربه در زمینه مهاجرت، به عنوان یکی از معتبرترین موسسات در این حوزه شناخته می‌شود. ما با ارائه خدمات مشاوره‌ای دقیق و به‌روز، به شما کمک می‌کنیم تا بهترین تصمیمات را در مسیر مهاجرت خود اتخاذ کنید. تیم ما متشکل از وکلای مجرب و مشاوران حرفه‌ای است که با دانش و تجربه خود، شما را در تمامی مراحل مهاجرت همراهی می‌کنند.
                        </p>
                  </motion.div>
            </div>
      )
...
// memo کردن کامپوننت برای جلوگیری از رندر اضافی
