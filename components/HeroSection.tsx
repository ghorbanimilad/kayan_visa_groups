    ...
    >
      ...
      <div className="relative z-10 w-full px-6  flex flex-col lg:flex-row justify-between items-end gap-8 max-w-[1400px] mx-auto">
        ...
        <div className="flex flex-col items-center py-8 lg:items-start text-center lg:text-right w-full lg:w-1/2">
          ...
          >
            موسسه مهاجرتی کایان با بیش از 19 سال سابقه در زمینه مهاجرت به روش های مختلف و به چندین کشور و با چند شعبه فعال در ایران و خارج آماده ارائه خدمات به شماست. ما مشاوره مهاجرتی تخصصی‌ و خدمات مهاجرتی را با بهترین هزینه ها به شما ارائه می‌دهیم.
          </motion.p>
