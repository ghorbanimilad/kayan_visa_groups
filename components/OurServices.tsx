      ...
      <div className="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-5 gap-8">
        {services.map((service, index) => (
          <motion.div
            ...
            className="flex items-center space-y-2 justify-center flex-col min-w-40 md:max-w-48 min-h-60 border border-gray-400 p-4 rounded-lg text-center hover:border-2 hover:scale-105 transition-all duration-300 hover:border-red-300 hover:shadow-xl relative overflow-hidden will-change-transform"
          >
            {service.icon}
